# app.py - Free Fire API (Full Response - Parallel Check)
...
def format_full_response(data, region_used):
    """Format complete player data - FULL RESPONSE"""
    if not data:
    ...
    return jsonify({
        ...
        "endpoints": {
            "/get": {
                ...
                "description": "Checks ALL regions in parallel and returns FULL player info"
            },
...
def get_account_info():
    ...
    if best_data:
        response = format_full_response(best_data, best_region)
...
if __name__ == '__main__':
    print("=" * 55)
    print("🚀 Free Fire API - FULL RESPONSE")
    print("⚡ Developed by: BISHAL & SENKU")
    print("🔥 Checks ALL regions in PARALLEL")
    print("🏆 Returns FULL player info with highest level")
    print("=" * 55)
